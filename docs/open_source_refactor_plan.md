...
| File | Issue |
|------|-------|
| [README.md](file:///Users/user/Documents/GitHub/codex-multipass/README.md#L41) | `brew install BigCactusLabs/tap/codex-switch` |
| [codex-switch.rb](file:///Users/user/Documents/GitHub/codex-multipass/homebrew/Formula/codex-switch.rb#L3-L8) | `homepage`, `url`, `head` hardcode `BigCactusLabs/codex-multipass` |
| [update_formula.sh](file:///Users/user/Documents/GitHub/codex-multipass/scripts/update_formula.sh#L51-L52) | awk pattern + replacement hardcode `BigCactusLabs/codex-multipass` |
...
#### [NEW] [.gitignore](file:///Users/user/Documents/GitHub/codex-multipass/.gitignore)
...
#### [DELETE] [codex-switch-0.1.0.tar.gz](file:///Users/user/Documents/GitHub/codex-multipass/codex-switch-0.1.0.tar.gz)
- Build artifact — will be generated by GitHub Releases

### 1b · Add license and community docs

#### [NEW] [LICENSE](file:///Users/user/Documents/GitHub/codex-multipass/LICENSE)
- MIT, copyright `BigCactusLabs contributors`

#### [NEW] [CODE_OF_CONDUCT.md](file:///Users/user/Documents/GitHub/codex-multipass/CODE_OF_CONDUCT.md)
- Contributor Covenant v2.1

#### [NEW] [CHANGELOG.md](file:///Users/user/Documents/GitHub/codex-multipass/CHANGELOG.md)
- Bootstrap `## 0.1.0` — summarize current feature set
- [Keep a Changelog](https://keepachangelog.com/) format

#### [NEW] [CONTRIBUTING.md](file:///Users/user/Documents/GitHub/codex-multipass/CONTRIBUTING.md)
- How to run tests, code style, PR process
- **Include Release Flow** migrated from [codex_switcher_engineer_handoff.md](file:///Users/user/Documents/GitHub/codex-multipass/codex_switcher_engineer_handoff.md) lines 34–39

#### [DELETE] [codex_switcher_engineer_handoff.md](file:///Users/user/Documents/GitHub/codex-multipass/codex_switcher_engineer_handoff.md)
...
> Replace all `BigCactusLabs/codex-multipass` → `BigCactusLabs/codex-multipass`. Three files.

#### [MODIFY] [README.md](file:///Users/user/Documents/GitHub/codex-multipass/README.md#L41)
- `brew install BigCactusLabs/tap/codex-switch` → `brew install BigCactusLabs/tap/codex-switch`

#### [MODIFY] [codex-switch.rb](file:///Users/user/Documents/GitHub/codex-multipass/homebrew/Formula/codex-switch.rb)
...
#### [MODIFY] [update_formula.sh](file:///Users/user/Documents/GitHub/codex-multipass/scripts/update_formula.sh)
- awk pattern (line 51): `BigCactusLabs\/codex-multipass` → `BigCactusLabs\/codex-multipass`
- replacement (line 52): `BigCactusLabs/codex-multipass` → `BigCactusLabs/codex-multipass`

### Phase 2 Verification
```bash
# No personal refs remain
rg -i 'placeholder' --glob '!.git' . && echo "FAIL" || echo "PASS"
...
#### [NEW] [.github/workflows/ci.yml](file:///Users/user/Documents/GitHub/codex-multipass/.github/workflows/ci.yml)
...
#### [MODIFY] [docs/repo_folder_map.md](file:///Users/user/Documents/GitHub/codex-multipass/docs/repo_folder_map.md)
